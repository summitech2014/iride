        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-10 text-lg">
                ...
                <div class="relative dropdown group py-4"> 
                    <a href="product.html" class="text-lg font-medium text-gray-300 group-hover:text-white flex items-center transition-colors">
                    ...
                    <div class="dropdown-menu hidden absolute top-full left-0 w-56 bg-zinc-900 border border-white/10 rounded-xl shadow-2xl py-2">
                            <div class="relative nested-dropdown px-4 py-2 text-base text-gray-300 hover:bg-white/10 hover:text-white cursor-default flex justify-between items-center group/nested">
                                <span data-i18n="cat_iride">iRide 系列</span> <i data-lucide="chevron-right" class="w-4 h-4"></i>
                            ...
                            <div class="relative nested-dropdown px-4 py-2 text-base text-gray-300 hover:bg-white/10 hover:text-white cursor-default flex justify-between items-center group/nested">
                                <span data-i18n="cat_sport">BIKTOK 系列</span> <i data-lucide="chevron-right" class="w-4 h-4"></i>
                                <div class="nested-menu">
                                    <div class="w-40 bg-zinc-900 border border-white/10 rounded-xl shadow-2xl py-2">
                                        <a href="BH03.html" class="block px-4 py-2 text-base text-gray-400 hover:text-white hover:bg-white/5">BH03</a>
                                    </div>
                                </div>
                            </div>
                    </div>
                ...
                <div class="relative dropdown group py-4">
                    ...
                    <div class="dropdown-menu hidden absolute top-full left-0 w-56 bg-zinc-900 border border-white/10 rounded-xl shadow-2xl py-2">
                        ...
                        <a href="Support Policy.html" data-i18n="sup_Support" class="block px-4 py-2 text-base text-gray-300 hover:bg-white/10 hover:text-white">售後服務政策</a>
            ...
            <div class="px-2 py-3 space-y-1 max-h-[70vh] overflow-y-auto">
                ...
                <div class="px-0">
                    ...
                    <div id="mobile-products-panel" class="hidden pl-3 space-y-1 pt-1">
                        <a href="product.html" class="block px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-white/5 hover:text-white" onclick="closeMobileMenu()">
                            <span data-i18n="nav_iRide">產品列表</span>
                        </a>

                        <!-- Nested accordion: iRide Systems -->
                        <button
                            type="button"
                            ...
                            aria-controls="mobile-iride-panel"
                            aria-expanded="false"
                            onclick="toggleAccordion('mobile-iride-panel', this)"
                        >
                        <span data-i18n="cat_iride">iRide 系列</span>
                        <i data-lucide="chevron-down" class="w-4 h-4 transition-transform"></i>
                        </button>
                        ...
                        <div id="mobile-biktok-panel" class="hidden pl-3 space-y-1">
                            <a href="BH03.html" class="block px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-white/5 hover:text-white" onclick="closeMobileMenu()">BH03</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-0">
                    ...
                    <div id="mobile-support-panel" class="hidden pl-3 space-y-1 pt-1">
                        ...
                        <a href="Support Policy.html" data-i18n="sup_Support" class="block px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-white/5 hover:text-white" onclick="closeMobileMenu()">售後服務政策</a>
...
const langData = {
    'zh': {
        ...
        'cat_iride':'iRide系列', 'cat_moto': 'J-TREK 系列', 'cat_sport': 'BIKTOK 系列',
    ...
    'en': {
        ...
        'cat_iride':'iRide Series', 'cat_moto': 'J-TREK Series', 'cat_sport': 'BIKTOK Series',
        'sup_Manual': 'Manuals', 'sup_jtrek': 'J-TREK Manuals', 'sup_video': 'Video Tutorials',
        'sup_Support':'Support Policy',
        //body
    ...
    'jp': {
        ...
        'cat_iride':'iRide シリーズ', 'cat_moto': 'J-TREK シリーズ', 'cat_sport': 'BIKTOK シリーズ',
        'sup_Manual': '説明書', 'sup_jtrek': 'J-TREK 説明書', 'sup_video': '動画チュートリアル',
        'sup_Support':'サポートポリシー',
...
function closeMobileMenu() {
    ...
    ['mobile-products-panel', 'mobile-support-panel', 'mobile-moto-panel', 'mobile-iride-panel', 'mobile-biktok-panel']
    .forEach(id => {
